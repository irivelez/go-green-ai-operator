...
console.log("\n=== handleOverride: every field variant produces correctly-namespaced action ===");
{
  ...
  await handleOverride("L_O4", { field: "price", corrected_value: { low: 200, high: 240 }, reason_code: "price_too_low" });
  await handleOverride("L_O4", { field: "address", corrected_value: "2 Other St", reason_code: "address_wrong" });
  await handleOverride("L_O4", { field: "decision", corrected_value: "escalate", reason_code: "should_have_escalated" });
