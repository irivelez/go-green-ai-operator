...
export const SEED_LEADS: Lead[] = [
  // 1) Happy A-lead, booked + work order (medium yard, biweekly, Mission 94110)
  {
    ...
    vision_assessment: { condition_score: 6, overgrowth: "med", cleanup_required: false, yard_size_estimate: "medium", confidence: 0.86 },
  ...
  // 2) Spanish A-lead, scheduled (small yard, weekly, Ingleside 94112)
  {
    ...
    vision_assessment: { condition_score: 7, overgrowth: "low", cleanup_required: false, yard_size_estimate: "small", confidence: 0.9 },
    lead_score: "A", risk_level: "low",
  ...
  // 4) Neglected yard → cleanup required before recurring (large, biweekly, Inner Richmond 94121)
  {
    ...
    vision_assessment: { condition_score: 3, overgrowth: "high", cleanup_required: true, yard_size_estimate: "large", confidence: 0.82 },
    lead_score: "A", risk_level: "low",
  ...
  // 8) Spanish, irrigation extra detected → ready to schedule (Castro 94114)
  {
    ...
    vision_assessment: { condition_score: 5, overgrowth: "med", cleanup_required: false, yard_size_estimate: "medium", confidence: 0.78, detected_extras: ["irrigation"] },
    lead_score: "A", risk_level: "low",
